...
import WrongNetworkImage from 'public/static/images/Onboarding/WrongNetwork.webp';
    ...
    <>
      ...
      <VStack mt={['30px']} w={'100%'} alignItems={'flex-start'}>
        ...
        <Text color={'black'} fontWeight={'medium'} fontSize={['md']}>
          Hit Play Now! on the top right. Login with your email and start
          exploring!
        </Text>
        <Divider
          m='20px 0'
...
const WrongNetworkModal = ({ onClick, isShowModal }: any) => {
